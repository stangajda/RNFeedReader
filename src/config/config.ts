const values = {
  ...
  API_TRENDING_PATH: '/3/trending/movie/day',
  // don't need hide this key because the movies data are public and not sensitive
  API_KEY: 'babcada8d42a5fd4857231c42240debd',
